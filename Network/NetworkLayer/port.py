...
class port():
    ...
    def print_port(self):
        print(str(self.port_IP) + " | " + str(self.link.dest_IP_address) + " | " + str(
            self.link.dest_port_IP) + " | " + str(self.link.cost))

    def return_port(self):
        return (str(self.port_IP) + " | " + str(self.link.dest_IP_address) + " | " + str(
            self.link.dest_port_IP) + " | " + str(self.link.cost))
