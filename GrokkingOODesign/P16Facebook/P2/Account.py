...
from GrokkingOODesign.P16Facebook.P1.ConnectionInvitationStatus import AccountStatus, ConnectionInvitationStatus
from GrokkingOODesign.P16Facebook.P3.Profile import Profile
