...
from GrokkingOODesign.P1LibraryManagementSystem.P1.BookFormat import AccountStatus, Constants, BookStatus, \
    ReservationStatus
from GrokkingOODesign.P1LibraryManagementSystem.P3.BookReservation import BookReservation, BookLending, Fine
