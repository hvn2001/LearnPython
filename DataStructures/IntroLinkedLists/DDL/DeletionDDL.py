from DataStructures.IntroLinkedLists.DDL.LinkedList import LinkedList
...
def delete(lst, value):
    ...
    if current_node.data is value:
        ...
        # Point the next element of the first element to head
    ...
    while current_node:
        if value is current_node.data:
            if current_node.next_element:
                ...
                next_node.previous_element = current_node.previous_element
